    ...
    if (result == result2)
    {
        if (atributo1 == 1)
        {
            ...
            case 1:
                ...
                printf("HOUVE UM EMPATE, SENDO OS VALORES %.2f DO USUARIO E %.2f DA MAQUINA", result, result2);
                break;
            case 2:
                printf("COM BASE NOS ATRIBUTOS SELECIONADOS: \n");
    ...
    }else if (result > result2)
    {
        if (atributo1 == 1)
        {
            ...
            case 1:
                printf("COM BASE NOS ATRIBUTOS SELECIONADOS: \n");
                printf("POPULAÇÃO E POPULAÇÃO \n");
                printf("O USUARIO VENCEU, SENDO OS VALORES %.2f DO USUARIO E %.2f DA MAQUINA", result, result2);
                break;
            case 2:
                printf("COM BASE NOS ATRIBUTOS SELECIONADOS: \n");
                printf("POPULAÇÃO E AREA \n");
    ...
    }else if (result < result2)
    {
        if (atributo1 == 1)
        {
            ...
            case 1:
                printf("COM BASE NOS ATRIBUTOS SELECIONADOS: \n");
                printf("POPULAÇÃO E POPULAÇÃO \n");
                printf("A MAQUINA VENCEU, SENDO OS VALORES %.2f DO USUARIO E %.2f DA MAQUINA", result, result2);
                break;
            case 2:
                printf("COM BASE NOS ATRIBUTOS SELECIONADOS: \n");
                printf("POPULAÇÃO E AREA \n");
